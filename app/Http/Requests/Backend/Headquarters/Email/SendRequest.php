...
class SendRequest extends BaseFormRequest
{
    ...
    public function rules() :array
    {
        return [
            ...
            'receiver_type' => 'required|in:'
                .SystemEmailReceiver::RECEIVER_TYPE_HEADQUARTERS.
                ','.SystemEmailReceiver::RECEIVER_TYPE_MERCHANT.
                ','.SystemEmailReceiver::RECEIVER_TYPE_PLAYER,
        ];
    }
