...
class GameFilter extends ModelFilter
{
     ...
     * @return object
     */
    public function game(int $game_id): object
    {
     ...
     */
    public function unassignPlatformSign(string $unassign_platform_sign): object
    {
     ...
     * @return GameFilter|\Illuminate\Database\Query\Builder
     */
    public function assignedPlatformSign(string $assigned_platform_sign): object
    {
