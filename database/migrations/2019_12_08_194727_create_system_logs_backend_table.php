...
class CreateSystemLogsBackendTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('system_logs_backend', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->unsignedInteger('route_id')->nullable()->default(null)->comment('路由id （backend_admin_routes表id）');
        ...
        \Illuminate\Support\Facades\DB::statement("ALTER TABLE `system_logs_backend` comment '后台操作日志'");
    }
