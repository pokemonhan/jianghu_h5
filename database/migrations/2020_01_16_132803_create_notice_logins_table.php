...
/**
 * Class CreateNoticeLoginsTable
 */
class CreateNoticeLoginsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up(): void
    {
        Schema::create(
            ...
            static function (Blueprint $table): void {
                ...
                $table->string('pic', 128)->default(' ')->comment('公告图片');
    ...
    {
        Schema::dropIfExists('notice_logins');
    }
}
