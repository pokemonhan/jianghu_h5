 ...
 */
class CreateFrontendUsersAuditTable extends Migration
{
    ...
    public function up(): void
    {
        Schema::create(
            ...
            static function (Blueprint $table): void {
                ...
                $table->decimal('amount', 18, 4)->nullable()->default(null)->comment('金额');
                $table->decimal('demand_bet', 18, 4)->nullable()->default(null)->comment('需求的打码量');
                $table->decimal('achieved_bet', 18, 4)->nullable()->default(null)->comment('完成的打码量');
                $table->tinyInteger('status')->nullable()->comment('状态 0未完成 1已完成');
