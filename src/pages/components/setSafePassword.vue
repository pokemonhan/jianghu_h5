<template>
    <div class="setSafePassword">
        <div class="setBox animated fadeInDown faster">
            ...
            <span class="setTitle">设置安全码</span>
            <div class="setBar">
                <div class="inputItem">
                    <div class="itemIcon">
                        <img class="icon" src="../../assets/login/icon_Lock.png"/>
                    </div>
                    <input :type="passwordState" class="inputEdit" v-model="password" placeholder="请设置安全码(取款密码)" @blur="checkPassword" @keyup="limitPassword" maxlength="16">
...
<script>
    export default {
        ...
        methods:{
            ...
            limitRePassword(){this.rePassword=this.rePassword.match(/[0-9]*/i)[0]},
            checkPassword(){
            ...
            checkRePassword(){
                ...
                else if(!/^([a-zA-Z0-9]{8})$/.test(this.rePassword)){
                    all.tool.editTipShow("请输入正确的8至16位数字或字母安全码！");
                    return false
                }
            ...
            toDoClose(){
                ...
                setTimeout(()=>{all.store.commit("isShowSetSafePassword",false)},150)
            },
            toDoCommit(){
