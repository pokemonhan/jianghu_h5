<template>
    <div class="setGamePassword">
        <div class="setBox animated fadeInDown faster">
            ...
            <span class="setTitle">修改登录密码</span>
            <div class="setBar">
                <div class="inputItem">
                    <div class="itemIcon">
                        <img class="icon" src="../../assets/login/icon_Lock.png"/>
                    </div>
                    <input :type="passwordState" class="inputEdit" v-model="password" placeholder="请设置安全码" @blur="checkPassword" @keyup="limitPassword" maxlength="40">
                ...
                <div class="inputItem">
                    ...
                    <input :type="passwordState" class="inputEdit" v-model="password" placeholder="请设置新的登录密码" @blur="checkPassword" @keyup="limitPassword" maxlength="40">
                    <img v-if="passwordState==='password'" class="iconEye" @click="passwordShow('text')" src="../../assets/mine/icon_EyeClose.png"/>
                    <img v-if="passwordState==='text'" class="iconEye" @click="passwordShow('password')" src="../../assets/mine/icon_EyeOpen.png"/>
                </div>
                <div class="inputItem">
                    ...
                    <input :type="passwordState" class="inputEdit" v-model="password" placeholder="请确认登录密码" @blur="checkPassword" @keyup="limitPassword" maxlength="40">
                    <img v-if="passwordState==='password'" class="iconEye" @click="passwordShow('text')" src="../../assets/mine/icon_EyeClose.png"/>
                    <img v-if="passwordState==='text'" class="iconEye" @click="passwordShow('password')" src="../../assets/mine/icon_EyeOpen.png"/>
                </div>
                <div class="inputItem">
                    ...
                    <input :type="passwordState" class="inputEdit" v-model="password" placeholder="请输入验证码" @blur="checkPassword" @keyup="limitPassword" maxlength="40">
                </div>
    ...
    export default {
        ...
        methods:{
            ...
            toDoClose(){
                ...
                setTimeout(()=>{all.store.commit("changePassword",{isShow:false})},150)
            },
            toDoCommit(){
                if(this.checkPassword()){
                    all.tool.send("changePassword",{password:this.password},res=>{
                        this.toDoClose();
