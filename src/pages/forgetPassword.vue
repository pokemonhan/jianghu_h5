<template>
    <div class="forgetPassword">
        ...
        <div class="contentView">
            ...
            <div class="forgetBox">
                <img class="bgForget" src="../assets/login/bg_Login.png"/>
                ...
                <div class="editBar">
                    ...
                    <div class="inputItem">
                        ...
                        <input class="inputEdit" :type="passwordState" v-model="password" placeholder="重置新密码（8-16位英文和数字组合）" @blur="checkPassword" @keyup="limitPassword" maxlength="16">
                ...
                <div class="commit" @click="toDoResetPassword">重置密码</div>
            </div>
        </div>
    </div>
</template>
    ...
    export default {
        data () {
            return {
                ...
                nextReqTime:null,
                banner:require("../assets/login/icon_RePassword.png")
            }
        },
        methods:{
            ...
            checkPassword(){
                if(this.password.length===0){
                    all.tool.editTipShow("新密码不能为空！");
                    return false
                }
                else if(!/^(?![0-9]+$)(?![a-zA-Z]+$)[0-9A-Za-z]{8,16}$/.test(this.password)){
                    all.tool.editTipShow("新密码为8-16位字母和数字组合！");
                    return false
                }
                else return true;
            },
            ...
            toDoGetCode(){
                if(this.checkMobile()){
                    ...
                    all.tool.send("resetPasswordCode",{mobile:this.mobile},res=>{
                        all.tool.setStore("forgetNextReqTime",res.data.nextReqTime);
