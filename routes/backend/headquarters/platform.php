...
Route::group(
    ...
    static function (): void {
        ...
        //运营商域名列表
        Route::match(['post', 'options'], 'domain-detail', [PlatformController::class, 'domainDetail'])->name($namePrefix . 'domain-detail');
        //添加运营商域名
        Route::match(['post', 'options'], 'domain-add', [PlatformController::class, 'domainAdd'])->name($namePrefix . 'domain-add');
        //删除已分配的游戏
        Route::match(
            ['post', 'options'],
        ...
        //分配游戏
        Route::match(['post', 'options'], 'assign-games', [PlatformController::class, 'assignGames'])->name($namePrefix . 'assign-games');
        //已分配的游戏
        Route::match(['get', 'options'], 'assigned-games', [PlatformController::class, 'assignedGames'])->name($namePrefix . 'assigned-games');
        //未分配的游戏
        Route::match(['get', 'options'], 'unassign-games', [PlatformController::class, 'unassignGames'])->name($namePrefix . 'unassign-games');
        //获取分配游戏接口的查询条件
        Route::match(
            ['get', 'options'],
